...
export default function CasaLista({ navigation, route }) {
  ...
  async function buscarGastos() {
    const listaGastos = await CasaService.listar();
    setGastos(listaGastos);
  }

  async function removerGasto(id) {
    await CasaService.remover(id);
  ...
  return (
    <View>
      <Button
        ...
        icon="plus"
        mode="contained"
        onPress={() => navigation.navigate("CasaForm")}
      >
        Cadastrar
      </Button>
          ...
          <Card style={{ margin: 10 }}>
            ...
            <Card.Actions>
              <Button
                ...
                onPress={() => navigation.navigate("CasaForm", item)}
              >
                Editar
              </Button>
              <Button
