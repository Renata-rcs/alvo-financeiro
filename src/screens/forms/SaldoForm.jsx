...
export default function SaldoForm({ navigation, route }) {
  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text variant='titleMedium' style={styles.subtitle}>ID Saldo: {gastoAntigo.id || 'NOVO'}</Text>

        <TextInput
          style={styles.input}
          mode='outlined'
          label="Nome"
          placeholder='Informe o nome do Saldo'
          value={nome}
